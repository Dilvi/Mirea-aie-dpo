...
- Категориальные признаки с высокой кардинальностью: **False**
...
Показаны top-3 значений для категориальных признаков.
См. файлы в папке `top_categories/`.

## Гистограммы числовых колонок

Построено не более **6** гистограмм числовых колонок.
