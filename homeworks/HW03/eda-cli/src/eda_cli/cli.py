...
def report(
    ...
    with md_path.open("w", encoding="utf-8") as f:
        # HW03 2.3.2: использование CLI-параметра --title
        f.write(f"# {title}\n\n")
        ...
        # HW03 2.3.2: вывод новых эвристик качества данных
        f.write(f"- Константные колонки: **{quality_flags['has_constant_columns']}**\n")
        f.write(
            f"- Категориальные признаки с высокой кардинальностью: "
        ...
        f.write(
            # HW03 2.3.2: использование CLI-параметра --max-hist-columns
            f"Построено не более **{max_hist_columns}** гистограмм числовых колонок.\n"
        )
