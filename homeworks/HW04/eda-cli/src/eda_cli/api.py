...
# HW04: собственный эндпоинт на базе эвристик HW03


@app.post(
    "/quality-flags-from-csv",
    tags=["quality"],
    summary="Возврат всех флагов качества из HW03 по CSV-файлу",
)
async def quality_flags_from_csv(file: UploadFile = File(...)) -> dict:
    """
    Новый эндпоинт HW04.

    Принимает CSV-файл, запускает EDA-ядро (HW03)
    ...
    # Возвращаем ВСЕ флаги (включая новые из HW03)
    return {
        "flags": flags_all,
    }
